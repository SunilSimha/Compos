# This file calls transfunction.py to calculate transfunction
# for a set of given cosmological parameters.
...
mp.savefig('../../results/transfunction/transf(h=' + str(const.cosmo['h']) +
           ',O_0=' + str(const.cosmo['omega_0']) + ',O_b=' +
           str(const.cosmo['omega_b']) + ').pdf')
mp.show()
