#This script uses pyhalofit_nw.py to calculate the nonlinear, dewiggled power spectra.
...
mp.text(0.001,0.1, '$h = 0.7, \Omega_mh^2$ = '+str(const.cosmo['omega_0']*const.cosmo['h']**2)+',$ \Omega_qh^2 = $'+str(const.cosmo['omega_q']*const.cosmo['h']**2)+',',fontsize =15)
