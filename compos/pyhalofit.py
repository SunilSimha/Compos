#This code is a python version of halofit. It gives nonlinear correction on matter power spectrum. The formulas are in Appendix of 1208.2701.
...
def deltaq(k,z = 0): #Two halo terms(A2)
    ...
    def funy(x):
        return x / 4 + x ** 2 / 8
    deltal = matterps.normalizedmp(k,z) * k ** 3 / (2 * np.pi ** 2)
